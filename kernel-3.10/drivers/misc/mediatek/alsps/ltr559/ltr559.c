       ...
       unsigned long arg)       
{
  ...
  switch (cmd)
  {
    case ALSPS_SET_PS_MODE: //0x40048401
    ...
    case ALSPS_GET_PS_MODE: //0x80048402
    ...
    case ALSPS_GET_PS_DATA: //0x80048403
      ...
      //ok
    case ALSPS_GET_PS_RAW_DATA: //0x80048404      
      obj->ps = ltr559_ps_read();
      if(obj->ps < 0)
      {
        goto err_out;
    ...
    case ALSPS_SET_ALS_MODE: //0x40048405
      if(copy_from_user(&enable, ptr, sizeof(enable)))
      {
        err = -EFAULT;
        goto err_out;
    ...
    case ALSPS_GET_ALS_MODE: //0x80048406
    ...
    case ALSPS_GET_ALS_DATA: //0x80048407
        obj->als = ltr559_als_read(als_gainrange);
      if(obj->als < 0)
      {
        goto err_out;
    ...
    case ALSPS_GET_ALS_RAW_DATA: //0x80048408
    ...
    case ALSPS_GET_PS_TEST_RESULT: //0x80048409
      obj->ps = ltr559_ps_read();
      if(obj->ps < 0)
      {
        goto err_out;
    ...
    case ALSPS_IOCTL_CLR_CALI: //0x4004840f
    ...
    case ALSPS_IOCTL_GET_CALI: //0x80048410
      ps_cali = obj->ps_cali ;
    ...
    case ALSPS_IOCTL_SET_CALI: //0x40048411
    ...
    case ALSPS_SET_PS_THRESHOLD: //0x40048412
      break;
                
    case ALSPS_GET_PS_THRESHOLD_HIGH:  //0x8004840b
    ...
    case ALSPS_GET_PS_THRESHOLD_LOW:  //0x8004840c
