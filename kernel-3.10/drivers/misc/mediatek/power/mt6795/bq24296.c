...
{    
    ...
    battery_xlog_printk(BAT_LOG_CRTI,"[bq24296_init] init start\n");
    
    i2c_register_board_info(BQ24296_BUSNUM, &i2c_bq24296, 1);

    if(i2c_add_driver(&bq24296_driver)!=0)
    {
        battery_xlog_printk(BAT_LOG_CRTI,"[bq24296_init] failed to register bq24296 i2c driver.\n");
    }
    else
    {
        battery_xlog_printk(BAT_LOG_CRTI,"[bq24296_init] Success to register bq24296 i2c driver.\n");
    }
