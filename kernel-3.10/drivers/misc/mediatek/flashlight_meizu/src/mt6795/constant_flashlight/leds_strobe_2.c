...
#define TAG_NAME "[leds_strobe_2.c]"
...
#define I2C_STROBE_MAIN_CHANNEL_2        2
			...
			const struct i2c_device_id *id)
{
	...
	printk("LM3643 IC2 Initializing is done -\n");
    return 0;

err_chip_init:
	i2c_set_clientdata(client, NULL);
	kfree(chip);
	printk("LM3643_IC2 probe is failed \n");
	return -ENODEV;
}
...
#define LM3643_NAME "leds-LM3643-IC2"
...
{
	i2c_register_board_info(I2C_STROBE_MAIN_CHANNEL_2, &i2c_LM3643, 1);
