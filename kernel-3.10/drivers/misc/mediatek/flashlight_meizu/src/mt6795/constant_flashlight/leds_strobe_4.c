...
#define TAG_NAME "[leds_strobe_4.c]"
...
#define I2C_STROBE_MAIN_CHANNEL_0        0
			...
			const struct i2c_device_id *id)
{
	...
	printk("LM3643 IC4 Initializing is done -\n");
    return 0;

err_chip_init:
	i2c_set_clientdata(client, NULL);
	kfree(chip);
	printk("LM3643_IC4 probe is failed \n");
	return -ENODEV;
}
...
#define LM3643_NAME "leds-LM3643-IC4"
...
{
	i2c_register_board_info(I2C_STROBE_MAIN_CHANNEL_0, &i2c_LM3643, 1);
