...
#define TAG_NAME "[leds_strobe_3.c]"
...
#define I2C_STROBE_MAIN_CHANNEL_3        3
			...
			const struct i2c_device_id *id)
{
	...
	printk("LM3643 IC3 Initializing is done -\n");
    return 0;

err_chip_init:
	i2c_set_clientdata(client, NULL);
	kfree(chip);
	printk("LM3643_IC3 probe is failed \n");
	return -ENODEV;
}
...
#define LM3643_NAME "leds-LM3643-IC3"
...
{
	i2c_register_board_info(I2C_STROBE_MAIN_CHANNEL_3, &i2c_LM3643, 1);
