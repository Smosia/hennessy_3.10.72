...
extern BYTE s5k3m2_eeprom_data[DATA_SIZE];
#endif
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.sensor_interface_type = SENSOR_INTERFACE_TYPE_MIPI, //1,SENSOR_INTERFACE_TYPE_MIPI
	.mipi_sensor_type = MIPI_OPHY_NCSI2, //0,MIPI_OPHY_NCSI2;  1,MIPI_OPHY_CSI2
	.mipi_settle_delay_mode = MIPI_SETTLEDELAY_AUTO,//0,MIPI_SETTLEDELAY_AUTO; 1,MIPI_SETTLEDELAY_MANNUAL
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,// 1: SENSOR_OUTPUT_FORMAT_RAW_Gb
	.mclk = 24,
...
{
	{ 4192, 3104, 2096, 1552, 0, 0, 2096, 1552, 0, 0, 2096, 1552, 4192, 3104,  0,   0 },
	{ 4192, 3104, 4192, 3104, 0, 0, 4192, 3104, 0, 0, 4192, 3104, 4192, 3104,  0,   0 },
	{ 4192, 3104, 4192, 3104, 0, 0, 4192, 3104, 0, 0, 4192, 3104, 4192, 3104,  0, 485 },
	{ 4192, 2328, 1280, 720,  0, 0, 1280,  720, 0, 0, 1280,  720, 4192, 3104,  0, 485 },
	{ 4192, 2328, 1280, 720,  0, 0, 1280,  720, 0, 0, 1280,  720,   23,    0, 16,   0 }
...
void S5K3m2_2ND_MIPI_read_otp_wb(struct S5K3m2_MIPI_otp_struct *otp)
{
   	...
   	if(FLG==0)
		LOG_INF("[S5K3m2_2ND] [S5K3m2_2ND_MIPI_read_otp_wb] No OTP Data or OTP data is invalid");
   	else
   	{
...
static void normal_capture_setting()
{
	...
	if (chip_id == 0xC001) {
		...
		write_cmos_sensor_8(0xB05,0x00);
		write_cmos_sensor_8(0xB08,0x00);
		write_cmos_sensor_8(0xB00,0x00);
...
///
		...
		write_cmos_sensor(0x3B3A,0x3030);
		write_cmos_sensor(0x306A,0x0068);
		write_cmos_sensor_8(0x100,0x01);
		write_cmos_sensor_8(0x100,0x01);			
	} else {
