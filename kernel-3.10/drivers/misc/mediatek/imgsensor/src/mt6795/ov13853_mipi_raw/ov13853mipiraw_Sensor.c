...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0xbde6b5f8,        //checksum value for Camera Auto Test
    .pre = {
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =
{
    ...
    { 4256, 3152, 824, 842, 2608, 1468, 1304,  734, 4, 2, 1296,  730, 0, 0, 1280,  720 }, // hight speed video
...
static void set_shutter(kal_uint16 shutter)
{
	...
	write_cmos_sensor(0x3502, (shutter<<4) & 0xE0);	
...
static void capture_setting(kal_uint16 currefps)
{
    ...
    if (capture_first_flag == 0)
    {
        if (currefps == 150) 
        {
            ...
            write_cmos_sensor(0x3820, 0x44);
            write_cmos_sensor(0x3821, 0x00);
            write_cmos_sensor(0x3726, 0x88);
            write_cmos_sensor(0x3727, 0x33);
            write_cmos_sensor(0x3760, 0xF3);
            write_cmos_sensor(0x3807, 0x4F);
...
static void hs_video_setting()
{
    ...
    write_cmos_sensor(0x3501, 0x60);
    write_cmos_sensor(0x3612, 0x27);
    write_cmos_sensor(0x370A, 0x67);
    write_cmos_sensor(0x3729, 0x11);
    write_cmos_sensor(0x372A, 0x00);
    write_cmos_sensor(0x3718, 0x10);
    write_cmos_sensor(0x372F, 0x90);
    write_cmos_sensor(0x3801, 0x00);
    write_cmos_sensor(0x3802, 0x03);
    write_cmos_sensor(0x3803, 0x5A);
    write_cmos_sensor(0x3805, 0x9F);
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                if (OV13853_selective_read_eeprom_VCM_ID(6) == 0) {
