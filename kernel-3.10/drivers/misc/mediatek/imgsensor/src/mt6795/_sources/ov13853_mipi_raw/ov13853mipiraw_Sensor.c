...
/*static SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
    ...
    .i4SubBlkW  =16,
    .i4SubBlkH  =16,
	.i4PosL = {{8,19},{60,19},{24,23},{44,23},{12,39},{56,39},{28,43},{40,43},{28,51},{40,51},{12,55},{56,55},{24,71},{44,71},{8,75},{60,75}},    
    .i4PosR = {{8,23},{60,23},{24,27},{44,27},{12,35},{56,35},{28,39},{40,39},{28,55},{40,55},{12,59},{56,59},{24,67},{44,67},{8,71},{60,71}},
};*/
	static SET_PD_BLOCK_INFO_T imgsensor_pd_info =
	{
		.i4OffsetX = 64,
