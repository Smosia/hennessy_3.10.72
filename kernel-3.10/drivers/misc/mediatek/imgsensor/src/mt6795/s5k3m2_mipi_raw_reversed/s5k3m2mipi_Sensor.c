...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =	 
{
 ...
 { 4192, 3104, 0, 485, 4192, 2328, 1280,  720, 0, 0, 1280,  720, 0,	0, 1280,  720}, // hight video 120
 { 4192, 3104, 0, 485, 4192, 2328, 1280,  720, 0, 0, 1280,  720, 0,	0, 1280,  720}, // slim video 
};
...
struct S5K3m2_MIPI_otp_struct {
	...
	int vcm_driver_id;
	int otp_mapping_id;
	int r_ratio;//rg ratio
	int b_ratio;//bg ratio
	kal_uint16 R_Gain;
	kal_uint16 G_Gain;
	kal_uint16 B_Gain;
	int lenc[240];
...
static void sensor_init(void)
{
  ...
  if (chip_id == 0xC001) {
	...
	write_cmos_sensor(0x6F12, 0xD9);
	write_cmos_sensor(0x6F12, 0x846);
	...
	write_cmos_sensor(0x6F12, 0x832);
	...
	write_cmos_sensor(0x6F12, 0xF0);
	write_cmos_sensor(0x6F12, 0x701);
	...
	write_cmos_sensor(0x6F12, 0xC31);
	write_cmos_sensor(0x6F12, 0x880);
	...
	write_cmos_sensor(0x6F12, 0x888);
	...
	write_cmos_sensor(0x6F12, 0xC0F3);
	write_cmos_sensor(0x6F12, 0xC00);
	write_cmos_sensor(0x6F12, 0x1880);
	...
	write_cmos_sensor(0x6F12, 0x8142);
	write_cmos_sensor(0x6F12, 0xD3);
	write_cmos_sensor(0x6F12, 0x146);
	write_cmos_sensor(0x6F12, 0x6160);
	write_cmos_sensor(0x6F12, 0x208A);
	write_cmos_sensor(0x6F12, 0x23);
	write_cmos_sensor(0x6F12, 0xA6FB);
	write_cmos_sensor(0x6F12, 1);
	write_cmos_sensor(0x6F12, 0xA);
	write_cmos_sensor(0x6F12, 0x40EA);
	write_cmos_sensor(0x6F12, 0x160);
	write_cmos_sensor(0x6F12, 0xA0A);
	write_cmos_sensor(0x6F12, 0x6168);
	write_cmos_sensor(0x6F12, 0xA1FB);
	write_cmos_sensor(0x6F12, 0x67);
	write_cmos_sensor(0x6F12, 0x3FB);
	write_cmos_sensor(0x6F12, 0x70);
	write_cmos_sensor(0x6F12, 0x1FB);
	write_cmos_sensor(0x6F12, 0x201);
	write_cmos_sensor(0x6F12, 0x300B);
	write_cmos_sensor(0x6F12, 0x40EA);
	write_cmos_sensor(0x6F12, 0x150);
	write_cmos_sensor(0x6F12, 0xA0B);
	write_cmos_sensor(0x6F12, 0x6169);
	write_cmos_sensor(0x6F12, 0xA1FB);
	write_cmos_sensor(0x6F12, 0x67);
	write_cmos_sensor(0x6F12, 0x3FB);
	write_cmos_sensor(0x6F12, 0x70);
	write_cmos_sensor(0x6F12, 0x1FB);
	write_cmos_sensor(0x6F12, 0x200);
	write_cmos_sensor(0x6F12, 0x105);
	write_cmos_sensor(0x6F12, 0xE0);
	write_cmos_sensor(0x6F12, 0x2E0);
	...
	write_cmos_sensor(0x6F12, 0x902);
	...
	write_cmos_sensor(0x6F12, 0x921);
	write_cmos_sensor(0x6F12, 0x22);
	...
	write_cmos_sensor(0x6F12, 0x9B1);
	write_cmos_sensor(0x6F12, 0x5349);
	write_cmos_sensor(0x6F12, 0x864);
	...
	write_cmos_sensor(0x6F12, 0x40EA);
	write_cmos_sensor(0x6F12, 0x110);
	...
	write_cmos_sensor(0x6F12, 0x129);
	write_cmos_sensor(0x6F12, 0x3D9);
	write_cmos_sensor(0x6F12, 0x90F8);
	write_cmos_sensor(0x6F12, 0x8800);
	write_cmos_sensor(0x6F12, 0x128);
	write_cmos_sensor(0x6F12, 0x7D0);
	write_cmos_sensor(0x6F12, 0x22);
	...
	write_cmos_sensor(0x6F12, 0x3E0);
	write_cmos_sensor(0x6F12, 0x122);
	...
	write_cmos_sensor(0x6F12, 0x280);
	write_cmos_sensor(0x6F12, 0x2946);
	write_cmos_sensor(0x6F12, 0x2046);
	write_cmos_sensor(0x6F12, 0xBDE8);
	write_cmos_sensor(0x6F12, 0x7040);
	...
	write_cmos_sensor(0x6F12, 0x22);
	write_cmos_sensor(0x6F12, 0xAFF2);
	write_cmos_sensor(0x6F12, 0x931);
	...
	write_cmos_sensor(0x6F12, 0x42F6);
	write_cmos_sensor(0x6F12, 0xC50);
	write_cmos_sensor(0x6F12, 0xF0);
	...
	write_cmos_sensor(0x6F12, 0x320);
	write_cmos_sensor(0x6F12, 0x2000);
	write_cmos_sensor(0x6F12, 0x4290);
	write_cmos_sensor(0x6F12, 0x26);
	write_cmos_sensor(0x6F12, 0x4FF0);
	write_cmos_sensor(0x6F12, 0x109);
	write_cmos_sensor(0x6F12, 0x20);
	write_cmos_sensor(0x6F12, 0x2A8);
	write_cmos_sensor(0x6F12, 0xDDF8);
	write_cmos_sensor(0x6F12, 0x8A0);
	write_cmos_sensor(0x6F12, 0x98);
	write_cmos_sensor(0x6F12, 0xBF);
	write_cmos_sensor(0x6F12, 0x690);
	write_cmos_sensor(0x6F12, 0x498);
	write_cmos_sensor(0x6F12, 0xAFF3);
	write_cmos_sensor(0x6F12, 0x80);
	write_cmos_sensor(0x6F12, 0x590);
	write_cmos_sensor(0x6F12, 0x9D);
	write_cmos_sensor(0x6F12, 0xDDF8);
	write_cmos_sensor(0x6F12, 0x870);
	write_cmos_sensor(0x6F12, 0x26);
	write_cmos_sensor(0x6F12, 0);
	...
	write_cmos_sensor(0x6F12, 0x6047);
	write_cmos_sensor(0x6F12, 0x4CF6);
	write_cmos_sensor(0x6F12, 0xB7C);
	write_cmos_sensor(0x6F12, 0xC0F2);
	write_cmos_sensor(0x6F12, 0xC);
	write_cmos_sensor(0x6F12, 0x6047);
	write_cmos_sensor(0x6F12, 0);
	write_cmos_sensor(0x6F12, 0x30D2);
	write_cmos_sensor(0x6F12, 0x28B);
	write_cmos_sensor(0x6F12, 0);
	write_cmos_sensor(0x6F12, 0x4C7);
	...
	write_cmos_sensor_8(0x6F12, 0xF);
	write_cmos_sensor(0x602A, 0x7B00);
	write_cmos_sensor(0x6F12, 0x128);
	write_cmos_sensor(0x6F12, 0xDC);
	...
	write_cmos_sensor(0x6F12, 0x2000);
	write_cmos_sensor(0x6F12, 0x1000);
	write_cmos_sensor(0x6F12, 0x100);
	write_cmos_sensor(0x6F12, 0x200);
	write_cmos_sensor(0x6F12, 0x400);
	write_cmos_sensor(0x6F12, 0x800);
	write_cmos_sensor(0x6028, 0x4000);
	write_cmos_sensor_8(0xB04, 1);
	write_cmos_sensor(0x3B22, 0x1110);
	write_cmos_sensor(0x3BB2, 0x40);
	write_cmos_sensor(0x3BDC, 0x700);
	write_cmos_sensor(0x3BDE, 0x700);
	write_cmos_sensor(0x3BE6, 0x700);
	write_cmos_sensor(0x327A, 0x380);
	write_cmos_sensor(0xF42E, 0x200C);
	write_cmos_sensor_8(0x3B0D, 0xFF);
	write_cmos_sensor(0xF49E, 0x4C);
	write_cmos_sensor(0x3A74, 8);
	write_cmos_sensor(0xF4A6, 0xF0);
	write_cmos_sensor(0x3AFA, 0xFBB8);
	write_cmos_sensor(0xF49C, 0);
	write_cmos_sensor(0xF496, 0);
	write_cmos_sensor(0xF476, 0x40);
	write_cmos_sensor_8(0x3A86, 2);
	write_cmos_sensor_8(0x3A92, 6);
	write_cmos_sensor_8(0x3AAA, 2);
	write_cmos_sensor(0x3AFE, 0x7DF);
	write_cmos_sensor(0xF47A, 0x1B);
	write_cmos_sensor(0xF462, 3);
	write_cmos_sensor(0xF460, 0x20);
	write_cmos_sensor(0x3B06, 0xE);
	write_cmos_sensor(0x3AD0, 0x80);
	write_cmos_sensor(0x3B02, 0x20);
	write_cmos_sensor(0xF468, 1);
	write_cmos_sensor(0xF494, 0xE);
	write_cmos_sensor(0xF40C, 0x2180);
	write_cmos_sensor_8(0x3A7A, 0xF);
	write_cmos_sensor_8(0x3A7B, 0xF);
	write_cmos_sensor_8(0x3A7C, 0xF);
	write_cmos_sensor_8(0x3A7D, 0xF);
	...
	write_cmos_sensor_8(0x3005, 4);
	write_cmos_sensor_8(0x3A5F, 2);
	write_cmos_sensor(0x32C4, 2);
	write_cmos_sensor(0x32CA, 0x22B);
	write_cmos_sensor(0x32D0, 1);
	write_cmos_sensor(0x32D6, 0x22B);
	write_cmos_sensor(0x32DC, 3);
	write_cmos_sensor(0x32E2, 0x10);
	write_cmos_sensor(0x32E8, 0xDA);
	write_cmos_sensor(0x32EE, 0x10E);
	write_cmos_sensor(0x3864, 0x75);
	write_cmos_sensor(0x386A, 0x56);
	write_cmos_sensor(0x3870, 0x4C);
	write_cmos_sensor(0x3876, 0x11);
	write_cmos_sensor(0x387C, 0x73);
	write_cmos_sensor(0x3882, 0x58);
	write_cmos_sensor(0x3888, 0x48);
	write_cmos_sensor(0x388E, 0x14);
	write_cmos_sensor(0x3894, 0x73);
	write_cmos_sensor(0x389A, 0x58);
	write_cmos_sensor(0x38A0, 0x48);
	write_cmos_sensor(0x38A6, 0x14);
	write_cmos_sensor(0x38AC, 0x14);
	write_cmos_sensor(0x32F4, 0xD4);
	write_cmos_sensor(0x32FA, 0x22F);
	write_cmos_sensor(0x3300, 0xDA);
	write_cmos_sensor(0x3306, 0x22D);
	write_cmos_sensor(0x330C, 0xD4);
	write_cmos_sensor(0x3312, 0x12E);
	write_cmos_sensor(0x3318, 3);
	write_cmos_sensor(0x331E, 0x57);
	write_cmos_sensor(0x3324, 3);
	write_cmos_sensor(0x332A, 0x59);
	write_cmos_sensor(0x3330, 3);
	write_cmos_sensor(0x3336, 0x4E);
	write_cmos_sensor(0x333C, 3);
	write_cmos_sensor(0x3342, 0x52);
	write_cmos_sensor(0x3348, 3);
	write_cmos_sensor(0x334E, 0xD4);
	write_cmos_sensor(0x3354, 3);
	write_cmos_sensor(0x335A, 0xB);
	write_cmos_sensor(0x3360, 0x10E);
	write_cmos_sensor(0x3366, 0x128);
	write_cmos_sensor(0x336C, 3);
	write_cmos_sensor(0x3372, 5);
	write_cmos_sensor(0x3378, 0x10E);
	write_cmos_sensor(0x337E, 0x110);
	write_cmos_sensor(0x3384, 0x5A);
	write_cmos_sensor(0x338A, 0x63);
	write_cmos_sensor(0x3390, 0x234);
	write_cmos_sensor(0x3396, 0x64);
	write_cmos_sensor(0x339C, 0x22D);
	write_cmos_sensor(0x33A2, 5);
	write_cmos_sensor(0x33A8, 3);
	write_cmos_sensor(0x33AE, 0xC);
	write_cmos_sensor(0x33B4, 0x63);
	write_cmos_sensor(0x33BA, 0x9D);
	write_cmos_sensor(0x33C0, 0xD4);
	write_cmos_sensor(0x33C6, 0x18B);
	write_cmos_sensor(0x33CC, 0x22B);
	write_cmos_sensor(0x33D2, 0xD7);
	write_cmos_sensor(0x33D8, 0xEE);
	write_cmos_sensor(0x33DE, 0xDE);
	write_cmos_sensor(0x33E4, 0xF6);
	write_cmos_sensor(0x33EA, 0xE6);
	write_cmos_sensor(0x33F0, 0xF6);
	write_cmos_sensor(0x33F6, 0xD7);
	write_cmos_sensor(0x33FC, 0xD9);
	write_cmos_sensor(0x3402, 1);
	write_cmos_sensor(0x3408, 5);
	write_cmos_sensor(0x340E, 0xDE);
	write_cmos_sensor(0x3414, 0xF6);
	write_cmos_sensor(0x341A, 1);
	write_cmos_sensor(0x3420, 5);
	write_cmos_sensor(0x3426, 0xD7);
	write_cmos_sensor(0x342C, 0xD9);
	write_cmos_sensor(0x3432, 0x9D);
	write_cmos_sensor(0x3438, 0xAF);
	write_cmos_sensor(0x343E, 0xBF);
	write_cmos_sensor(0x3444, 0xD4);
	write_cmos_sensor(0x344A, 0x18B);
	write_cmos_sensor(0x3450, 0x1D2);
	write_cmos_sensor(0x3456, 0x1E2);
	write_cmos_sensor(0x345C, 0x22B);
	write_cmos_sensor(0x3462, 0xB1);
	write_cmos_sensor(0x3468, 0xB6);
	write_cmos_sensor(0x346E, 0xDA);
	write_cmos_sensor(0x3474, 0xE0);
	write_cmos_sensor(0x347A, 0xEB);
	write_cmos_sensor(0x3480, 0xF1);
	write_cmos_sensor(0x3486, 0x1D4);
	write_cmos_sensor(0x348C, 0x1D9);
	write_cmos_sensor(0x3492, 0x22F);
	write_cmos_sensor(0x3498, 0x234);
	write_cmos_sensor(0x349E, 0xB3);
	write_cmos_sensor(0x34A4, 0xB7);
	write_cmos_sensor(0x34AA, 0xDC);
	write_cmos_sensor(0x34B0, 0xE1);
	write_cmos_sensor(0x34B6, 0xED);
	write_cmos_sensor(0x34BC, 0xF2);
	write_cmos_sensor(0x34C2, 0x1D6);
	write_cmos_sensor(0x34C8, 0x1DA);
	write_cmos_sensor(0x34CE, 0x231);
	write_cmos_sensor(0x34D4, 0x235);
	write_cmos_sensor(0x34DA, 0xB4);
	write_cmos_sensor(0x34E0, 0xB7);
	write_cmos_sensor(0x34E6, 0xDD);
	write_cmos_sensor(0x34EC, 0xE1);
	write_cmos_sensor(0x34F2, 0xEE);
	write_cmos_sensor(0x34F8, 0xF2);
	write_cmos_sensor(0x34FE, 0x1D7);
	write_cmos_sensor(0x3504, 0x1DA);
	write_cmos_sensor(0x350A, 0x232);
	write_cmos_sensor(0x3510, 0x235);
	write_cmos_sensor(0x3516, 0xB2);
	write_cmos_sensor(0x351C, 0xB4);
	write_cmos_sensor(0x3522, 0xD7);
	write_cmos_sensor(0x3528, 0xD9);
	write_cmos_sensor(0x352E, 0xE8);
	write_cmos_sensor(0x3534, 0xEA);
	write_cmos_sensor(0x353A, 0x1D5);
	write_cmos_sensor(0x3540, 0x1D7);
	write_cmos_sensor(0x3546, 0x22D);
	write_cmos_sensor(0x354C, 0x22F);
	write_cmos_sensor(0x3552, 1);
	write_cmos_sensor(0x3558, 5);
	write_cmos_sensor(0x355E, 0xB6);
	write_cmos_sensor(0x3564, 0xB9);
	write_cmos_sensor(0x356A, 0xDC);
	write_cmos_sensor(0x3570, 0xE1);
	write_cmos_sensor(0x3576, 0xED);
	write_cmos_sensor(0x357C, 0xF2);
	write_cmos_sensor(0x3582, 0x1D9);
	write_cmos_sensor(0x3588, 0x1DC);
	write_cmos_sensor(0x358E, 0x231);
	write_cmos_sensor(0x3594, 0x235);
	write_cmos_sensor(0x359A, 1);
	write_cmos_sensor(0x35A0, 5);
	write_cmos_sensor(0x35A6, 0xB2);
	write_cmos_sensor(0x35AC, 0xB4);
	write_cmos_sensor(0x35B2, 0xD7);
	write_cmos_sensor(0x35C4, 0xD9);
	write_cmos_sensor(0x35CA, 0xE8);
	write_cmos_sensor(0x35D0, 0xEA);
	write_cmos_sensor(0x35D6, 0x1D5);
	write_cmos_sensor(0x35DC, 0x1D7);
	write_cmos_sensor(0x35E2, 0x22D);
	write_cmos_sensor(0x35E8, 0x22F);
	write_cmos_sensor(0x35EE, 0xB6);
	write_cmos_sensor(0x35F4, 0xDC);
	write_cmos_sensor(0x35FA, 0x1D9);
	write_cmos_sensor(0x3600, 0x22F);
	write_cmos_sensor(0x3606, 0x9C);
	write_cmos_sensor(0x360C, 0xD6);
	write_cmos_sensor(0x3612, 0x18A);
	write_cmos_sensor(0x3618, 0x22C);
	write_cmos_sensor(0x361E, 1);
	write_cmos_sensor(0x3624, 5);
	write_cmos_sensor(0x362A, 0xD7);
	write_cmos_sensor(0x3630, 0xEE);
	write_cmos_sensor(0x3636, 0xEE);
	write_cmos_sensor(0x363C, 0xEE);
	write_cmos_sensor(0x3642, 0xD7);
	write_cmos_sensor(0x3648, 0xD9);
	write_cmos_sensor(0x364E, 0xD9);
	write_cmos_sensor(0x3654, 0xD9);
	write_cmos_sensor(0x365A, 0x3C);
	write_cmos_sensor(0x3660, 0xA);
	write_cmos_sensor(0x3666, 0x63);
	write_cmos_sensor(0x366C, 0x231);
	write_cmos_sensor(0x3672, 0x64);
	write_cmos_sensor(0x3678, 0x66);
	write_cmos_sensor(0x367E, 0xD6);
	write_cmos_sensor(0x3684, 0xD9);
	write_cmos_sensor(0x368A, 0x22D);
	write_cmos_sensor(0x3690, 0x230);
	write_cmos_sensor(0x3696, 0xD6);
	write_cmos_sensor(0x369C, 2);
	write_cmos_sensor(0x36A2, 0x63);
	write_cmos_sensor(0x36A8, 0x9F);
	write_cmos_sensor(0x36AE, 0xD6);
	write_cmos_sensor(0x36B4, 0x18D);
	write_cmos_sensor(0x36BA, 0x22D);
	write_cmos_sensor(0x36C0, 0);
	write_cmos_sensor(0x36C6, 0);
	write_cmos_sensor(0x36CC, 0x6E);
	write_cmos_sensor(0x36D2, 0x234);
	write_cmos_sensor(0x36D8, 0);
	write_cmos_sensor(0x36DE, 0);
	write_cmos_sensor(0x36E4, 0);
	write_cmos_sensor(0x36EA, 0);
	write_cmos_sensor(0x36F0, 0);
	write_cmos_sensor(0x36F6, 0);
	write_cmos_sensor(0x36FC, 0);
	write_cmos_sensor(0x3702, 0);
	write_cmos_sensor(0x3708, 0);
	write_cmos_sensor(0x370E, 0);
	write_cmos_sensor(0x3714, 0);
	write_cmos_sensor(0x371A, 0);
	write_cmos_sensor(0x3720, 0);
	write_cmos_sensor(0x3726, 0);
	write_cmos_sensor(0x372C, 0);
	write_cmos_sensor(0x3732, 0);
	write_cmos_sensor(0x3738, 0);
	write_cmos_sensor(0x373E, 0);
	write_cmos_sensor(0x3744, 0x65);
	write_cmos_sensor(0x374A, 0x232);
	write_cmos_sensor(0x3750, 0);
	write_cmos_sensor(0x3756, 0);
	write_cmos_sensor(0x375C, 0);
	write_cmos_sensor(0x3762, 0);
	write_cmos_sensor(0x3768, 0);
	write_cmos_sensor(0x376E, 0);
	write_cmos_sensor(0x3774, 0);
	write_cmos_sensor(0x377A, 0);
	write_cmos_sensor(0x3780, 0);
	write_cmos_sensor(0x3786, 0);
	write_cmos_sensor(0x378C, 0);
	write_cmos_sensor(0x3792, 0);
	write_cmos_sensor(0x3798, 0);
	write_cmos_sensor(0x379E, 0);
	write_cmos_sensor(0x37A4, 0);
	write_cmos_sensor(0x37AA, 0);
	write_cmos_sensor(0x38B2, 0xA);
	write_cmos_sensor(0x38C4, 2);
	write_cmos_sensor(0x37B0, 8);
	write_cmos_sensor(0x37B6, 0x10);
	write_cmos_sensor(0x37BC, 0x20);
	write_cmos_sensor(0x37C2, 0x28);
	write_cmos_sensor(0x37C8, 0x38);
	write_cmos_sensor(0x37CE, 0x40);
	write_cmos_sensor(0x37D4, 0x50);
	write_cmos_sensor(0x37DA, 0x58);
	write_cmos_sensor(0x37E0, 0x68);
	write_cmos_sensor(0x37E6, 0x70);
	write_cmos_sensor(0x37EC, 0x80);
	write_cmos_sensor(0x37F2, 0x88);
	write_cmos_sensor(0x37F8, 0x98);
	write_cmos_sensor(0x37FE, 0xA0);
	write_cmos_sensor(0x3804, 0xB0);
	write_cmos_sensor(0x380A, 0xB8);
	write_cmos_sensor(0x3810, 0xF0);
	write_cmos_sensor(0x3816, 0xF8);
	write_cmos_sensor(0x381C, 0x108);
	write_cmos_sensor(0x3822, 0x110);
	write_cmos_sensor(0x3828, 0x17);
	write_cmos_sensor(0x382E, 0x2F);
	write_cmos_sensor(0x3834, 0x47);
	write_cmos_sensor(0x383A, 0x5F);
	write_cmos_sensor(0x3840, 0x77);
	write_cmos_sensor(0x3846, 0x8F);
	write_cmos_sensor(0x384C, 0xA7);
	write_cmos_sensor(0x3852, 0xED);
	write_cmos_sensor(0x3858, 0xFF);
	write_cmos_sensor(0x385E, 0x117);
	write_cmos_sensor(0x38CA, 0x136);
	write_cmos_sensor(0x38D0, 0x170);
	write_cmos_sensor(0x38D6, 0x28D);
	write_cmos_sensor(0x38DC, 0);
	write_cmos_sensor(0x38E2, 0x62);
	write_cmos_sensor(0x38E8, 0x23E);
	write_cmos_sensor(0x38EE, 0x1F);
	write_cmos_sensor(0x38F4, 0x136);
	write_cmos_sensor(0x38FA, 0x170);
	write_cmos_sensor(0x3900, 0x28D);
	write_cmos_sensor(0x3906, 0);
	write_cmos_sensor(0x390C, 0x62);
	write_cmos_sensor(0x3912, 0x23E);
	write_cmos_sensor(0x3918, 0x1F);
	write_cmos_sensor(0x391E, 0x136);
	write_cmos_sensor(0x3924, 0x172);
	write_cmos_sensor(0x392A, 0x28D);
	write_cmos_sensor(0x3930, 0);
	write_cmos_sensor(0x3936, 0x62);
	write_cmos_sensor(0x393C, 0x23E);
	write_cmos_sensor(0x3942, 0x1F);
	write_cmos_sensor(0x3948, 0x136);
	write_cmos_sensor(0x394E, 0x172);
	write_cmos_sensor(0x3954, 0x28D);
	write_cmos_sensor(0x395A, 0);
	write_cmos_sensor(0x3960, 0x62);
	write_cmos_sensor(0x3966, 0x23E);
	write_cmos_sensor(0x396C, 0x1F);
	write_cmos_sensor_8(0x3A03, 3);
	write_cmos_sensor_8(0x3A04, 3);
	write_cmos_sensor_8(0x3A07, 3);
	write_cmos_sensor_8(0x3A08, 3);
	write_cmos_sensor_8(0x3993, 0);
	write_cmos_sensor_8(0x3994, 6);
	write_cmos_sensor_8(0x3995, 0);
	write_cmos_sensor_8(0x3993, 0);
	write_cmos_sensor_8(0x3A16, 0);
	write_cmos_sensor_8(0x3A17, 0);
	write_cmos_sensor_8(0x3A18, 0);
	write_cmos_sensor_8(0x3A19, 3);
	write_cmos_sensor_8(0x3A1A, 3);
	write_cmos_sensor_8(0x3A1B, 6);
	write_cmos_sensor_8(0x3A1E, 0);
	write_cmos_sensor_8(0x3A1F, 6);
	write_cmos_sensor_8(0x3A32, 0);
	write_cmos_sensor_8(0x3A33, 6);
	write_cmos_sensor(0x9804, 0x68);
	write_cmos_sensor(0x9806, 0x10E8);
	write_cmos_sensor(0x9808, 0x2E);
	write_cmos_sensor(0x980A, 0xC8E);
	write_cmos_sensor(0x623E, 4);  
  ...
  //s 2014/12/01, bruce
	...
	write_cmos_sensor(0x6F12, 0xA48);
	write_cmos_sensor(0x6F12, 0x2988);
	write_cmos_sensor(0x6F12, 0x180);
	write_cmos_sensor(0x6F12, 0x6988);
	write_cmos_sensor(0x6F12, 0x4180);
	...
	write_cmos_sensor(0x6F12, 0x448);
	write_cmos_sensor(0x6F12, 0xF0);
	write_cmos_sensor(0x6F12, 0xDB8);
	write_cmos_sensor(0x6F12, 0x2000);
	write_cmos_sensor(0x6F12, 0x34D0);
	write_cmos_sensor(0x6F12, 0x2000);
	...
	write_cmos_sensor(0x6F12, 0);
	write_cmos_sensor(0x6F12, 0x30D2);
	write_cmos_sensor(0x6F12, 0x29C);
	write_cmos_sensor(0x6F12, 0);
	write_cmos_sensor(0x6F12, 1);
	...
	write_cmos_sensor(0x3876, 0x11);
	write_cmos_sensor(0x3366, 0x128);
	write_cmos_sensor(0x3852, 0xEA);
	write_cmos_sensor(0x623E, 4);
	write_cmos_sensor(0x3B5C, 6);
  } else  // all other ID
...
static void preview_setting(void)
{
	...
	if (chip_id == 0xC001) {
		...
		write_cmos_sensor(0x32CA, 0x22B);
		write_cmos_sensor(0x32D6, 0x22B);
		write_cmos_sensor(0x344, 0xC);
		write_cmos_sensor(0x346, 8);
		write_cmos_sensor(0x348, 0x1073);
		write_cmos_sensor(0x34A, 0xC37);
		write_cmos_sensor(0x34C, 0x830);
		write_cmos_sensor(0x34E, 0x610);
		write_cmos_sensor_8(0x901, 0x12);
		write_cmos_sensor(0x380, 1);
		write_cmos_sensor(0x382, 1);
		write_cmos_sensor(0x384, 1);
		write_cmos_sensor(0x386, 3);
		write_cmos_sensor(0x400, 1);
		write_cmos_sensor(0x404, 0x20);
		write_cmos_sensor_8(0x114, 3);
		write_cmos_sensor_8(0x111, 2);
		write_cmos_sensor(0x112C, 0);
		write_cmos_sensor(0x112E, 0);
		write_cmos_sensor(0x136, 0x1800);
		write_cmos_sensor(0x304, 6);
		write_cmos_sensor(0x306, 0x6E);
		write_cmos_sensor(0x302, 1);
		write_cmos_sensor(0x300, 4);
		write_cmos_sensor(0x30C, 4);
		write_cmos_sensor(0x30E, 0x6A);
		write_cmos_sensor(0x30A, 1);
		write_cmos_sensor(0x308, 8);
		write_cmos_sensor(0x342, 0x11F0);
		write_cmos_sensor(0x340, 0xC74);
		write_cmos_sensor(0x202, 0x200);
		write_cmos_sensor(0x200, 0x400);
		write_cmos_sensor_8(0xB05, 0);
		write_cmos_sensor_8(0xB08, 0);
		write_cmos_sensor_8(0xB00, 0);
		write_cmos_sensor(0x3BBC, 0);
		write_cmos_sensor(0x3BBE, 0);
		write_cmos_sensor(0x3BC0, 0);
		write_cmos_sensor(0x3BC2, 0);
		write_cmos_sensor(0x3BC4, 0);
		write_cmos_sensor(0x3BC6, 0);
		write_cmos_sensor(0x3BC8, 0);
		write_cmos_sensor(0x3BCA, 0);
		write_cmos_sensor(0x3BCC, 0);
		write_cmos_sensor(0x3BCE, 0);
		write_cmos_sensor(0x3BD0, 0);
		write_cmos_sensor(0x3BD2, 0);
		write_cmos_sensor(0x3BD4, 0);
		write_cmos_sensor(0x3BD6, 0);
		write_cmos_sensor(0x3BD8, 0);
		write_cmos_sensor(0x3BDA, 0);
		write_cmos_sensor_8(0x3B3C, 1);
		...
		write_cmos_sensor(0x3C20, 0x80);
		write_cmos_sensor(0x3C22, 0x80);
		write_cmos_sensor(0x3C24, 0x80);
		write_cmos_sensor(0x3C26, 0x80);
		write_cmos_sensor(0x3C28, 0x80);
		write_cmos_sensor(0x3C2A, 0x80);
		write_cmos_sensor(0x3C2C, 0x80);
		write_cmos_sensor(0x3C2E, 0x80);
		write_cmos_sensor(0x3C30, 0x80);
		write_cmos_sensor(0x3C32, 0x80);
		write_cmos_sensor(0x3C34, 0x80);
		write_cmos_sensor(0x3C36, 0x80);
		write_cmos_sensor(0x3C38, 0x80);
		write_cmos_sensor(0x3C3A, 0x80);
		write_cmos_sensor(0x3C3C, 0x80);
		write_cmos_sensor(0x3C3E, 0x80);
		write_cmos_sensor(0x306A, 0x68);
		write_cmos_sensor_8(0x100, 1);
		...
		write_cmos_sensor_8(0x114, 3);
		write_cmos_sensor_8(0x111, 2);
		write_cmos_sensor(0x112C, 0x0);
		write_cmos_sensor(0x112E, 0x0);
		write_cmos_sensor(0x136, 0x1800);
		write_cmos_sensor(0x304, 6);
		write_cmos_sensor(0x306, 0x6E);
		write_cmos_sensor(0x302, 1);
		...
		write_cmos_sensor(0x202, 0x200);
		write_cmos_sensor(0x200, 0x400);
		write_cmos_sensor_8(0xB05, 0x0);
		write_cmos_sensor_8(0xB08, 0x0);
		write_cmos_sensor_8(0xB00, 0x0);
		write_cmos_sensor_8(0x3B3C, 1);
		write_cmos_sensor(0x3B34, 0x3030);
		write_cmos_sensor(0x3B36, 0x3030);
		write_cmos_sensor(0x3B38, 0x3030);
...
static void normal_capture_setting()
{
	...
	if (chip_id == 0xC001) {
		...
		write_cmos_sensor(0x32D6, 0x22B);
		write_cmos_sensor(0x344, 0xC);
		write_cmos_sensor(0x346, 0xC);
		write_cmos_sensor(0x348, 0x1073);
		write_cmos_sensor(0x34A, 0xC33);
		write_cmos_sensor(0x34C, 0x1060);
		write_cmos_sensor(0x34E, 0xC20);
		write_cmos_sensor_8(0x901, 0x11);
		write_cmos_sensor(0x380, 1);
		write_cmos_sensor(0x382, 1);
		write_cmos_sensor(0x384, 1);
		write_cmos_sensor(0x386, 1);
		write_cmos_sensor(0x400, 2);
		write_cmos_sensor(0x404, 0x10);
		write_cmos_sensor_8(0x114, 3);
		write_cmos_sensor_8(0x111, 2);
		write_cmos_sensor(0x112C, 0);
		write_cmos_sensor(0x112E, 0);
...
static void hs_video_setting()
{
	...
	if (chip_id == 0xC001) {
		...
		write_cmos_sensor(0x32CA, 0x22B);
		write_cmos_sensor(0x32D6, 0x22B);
		write_cmos_sensor(0x344, 0xBC);
		write_cmos_sensor(0x346, 0x1DC);
		write_cmos_sensor(0x348, 0xFC3);
		write_cmos_sensor(0x34A, 0xA63);
		write_cmos_sensor(0x34C, 0x500);
		write_cmos_sensor(0x34E, 0x2D0);
		write_cmos_sensor_8(0x901, 0x13);
		write_cmos_sensor(0x380, 1);
		write_cmos_sensor(0x382, 1);
		write_cmos_sensor(0x384, 1);
		write_cmos_sensor(0x386, 5);
		write_cmos_sensor(0x400, 1);
		write_cmos_sensor(0x404, 0x30);
		write_cmos_sensor_8(0x114, 3);
		write_cmos_sensor_8(0x111, 2);
		write_cmos_sensor(0x112C, 0);
		write_cmos_sensor(0x112E, 0);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->SensorClockPolarity = SENSOR_CLOCK_POLARITY_LOW; //1
	sensor_info->SensorClockFallingPolarity = SENSOR_CLOCK_POLARITY_LOW; //1 /* not use */
	sensor_info->SensorHsyncPolarity = SENSOR_CLOCK_POLARITY_LOW; //1 // inverse with datasheet
	sensor_info->SensorVsyncPolarity = SENSOR_CLOCK_POLARITY_LOW; //1
	sensor_info->SensorInterruptDelayLines = 4; //4 /* not use */
	sensor_info->SensorResetActiveHigh = FALSE; /* not use */
	sensor_info->SensorResetDelayCount = 5; //5 /* not use */

	sensor_info->SensroInterfaceType = imgsensor_info.sensor_interface_type; //1
	sensor_info->MIPIsensorType = imgsensor_info.mipi_sensor_type; 
	sensor_info->SettleDelayMode = imgsensor_info.mipi_settle_delay_mode;
	sensor_info->SensorOutputDataFormat = imgsensor_info.sensor_output_dataformat; //1

	sensor_info->CaptureDelayFrame = imgsensor_info.cap_delay_frame; //2
	sensor_info->PreviewDelayFrame = imgsensor_info.pre_delay_frame; //2
	sensor_info->VideoDelayFrame = imgsensor_info.video_delay_frame;  //2
	sensor_info->HighSpeedVideoDelayFrame = imgsensor_info.hs_video_delay_frame; //2
	sensor_info->SlimVideoDelayFrame = imgsensor_info.slim_video_delay_frame; //2
    sensor_info->Custom1DelayFrame = imgsensor_info.custom1_delay_frame;  //2
    sensor_info->Custom2DelayFrame = imgsensor_info.custom2_delay_frame;  //2
    sensor_info->Custom3DelayFrame = imgsensor_info.custom3_delay_frame;  //2
    sensor_info->Custom4DelayFrame = imgsensor_info.custom4_delay_frame;  //2
    sensor_info->Custom5DelayFrame = imgsensor_info.custom5_delay_frame;  //2

	sensor_info->SensorMasterClockSwitch = 0; //0 /* not use */
	sensor_info->SensorDrivingCurrent = imgsensor_info.isp_driving_current; //2
	
	sensor_info->AEShutDelayFrame = imgsensor_info.ae_shut_delay_frame; //0		 /* The frame of setting shutter default 0 for TG int */
	sensor_info->AESensorGainDelayFrame = imgsensor_info.ae_sensor_gain_delay_frame; //0	/* The frame of setting sensor gain */
	sensor_info->AEISPGainDelayFrame = imgsensor_info.ae_ispGain_delay_frame; //2
	sensor_info->IHDR_Support = imgsensor_info.ihdr_support;
	sensor_info->IHDR_LE_FirstLine = imgsensor_info.ihdr_le_firstline;
	sensor_info->SensorModeNum = imgsensor_info.sensor_mode_num;
	
	sensor_info->SensorMIPILaneNumber = imgsensor_info.mipi_lane_num; //3
	sensor_info->SensorClockFreq = imgsensor_info.mclk; //24
	sensor_info->SensorClockDividCount = 3; //3 /* not use */
	sensor_info->SensorClockRisingCount = 0; //0
	sensor_info->SensorClockFallingCount = 2; //2 /* not use */
	sensor_info->SensorPixelClockCount = 3; //3 /* not use */
	sensor_info->SensorDataLatchCount = 2; /* not use */
	
	sensor_info->MIPIDataLowPwr2HighSpeedTermDelayCount = 0; //0 
